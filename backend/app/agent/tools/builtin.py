...
def tool_calc(payload: dict[str, Any]) -> dict[str, Any]:
...
def tool_web_search_mock(payload: dict[str, Any]) -> dict[str, Any]:
...
def tool_fetch_paper_stub(payload: dict[str, Any]) -> dict[str, Any]:
